...
public class manageFriendRequests extends AppCompatActivity {
    ...
    private static final String TAG = "manageFriendRequests";
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        Query findAcceptedFriends = friendsRef.whereEqualTo("accepted", false);
        findAcceptedFriends.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    ListAdapter listAdapter = new ArrayAdapter<String>(manageFriendRequests.this, R.layout.friend_request_item, friends);
                    friendsList.setAdapter(listAdapter);
                } else {
                    Toast.makeText(manageFriendRequests.this, "Database failed.", Toast.LENGTH_SHORT).show();
                }
